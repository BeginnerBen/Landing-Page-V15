...
var html = [
	...
	'<li><button onclick="scrollFunction(1)"> Seciton 1  </button> </li>',
	'<li><button onclick="scrollFunction(2)"> Seciton 2 </button>  </li>',
	'<li><button onclick="scrollFunction(3)"> Seciton 3 </button></li>',
	'<li><button onclick="scrollFunction(4)"> Seciton 4 </button></li>',
	'</ul>',
